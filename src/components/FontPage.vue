<!--suppress HtmlUnknownTarget, CssNoGenericFontName -->
<style scoped>
dl
{
	font-size: 180%;
...
<template>
<div class="fill scroll max-height padding large-text">
	<div>一些自己项目用到的字体</div>
	...
	<article class="blur">
		<details>
			...
			<a class="chip medium-elevate small primary" href="https://www.hanyi.com.cn/productdetail?id=991" target="_blank">
				<i class="small">home</i>
				<span>官网</span>
			</a>

			<a class="chip medium-elevate small" href="https://www.hanyi.com.cn/faq-doc-1" target="_blank">
			...
			<code lang="html" ref="domHywhUsage"></code>
			...
			<div class="grid">
				<a class="s12 m12 l4" href="/astatine-gear/font-hywh/hywh.7z"> <button class="responsive small elevate"> <i>folder_zip</i> 汉仪文黑.7z</button> </a>
			</div>
		</details>
	</article>
	...
	<article class="blur">
		<details>
			<summary class="none">
				<div class="row">
					<div class="max">
						<h5 class="text-shadow">Source Code Pro</h5>
						<div>英文, 编程字体</div>
					</div>
					<i>arrow_drop_down</i>
				</div>
			...
			<a class="chip medium-elevate small primary" href="https://github.com/adobe-fonts/source-code-pro" target="_blank">
				<i class="small">home</i>
				<span>官网</span>
			</a>

			<a class="chip medium-elevate small" href="https://scripts.sil.org/cms/scripts/page.php?site_id=nrsi&id=OFL" target="_blank">
				<i class="small">credit_card</i>
				<span>开源 / SIL 开源字体许可</span>
			</a>

			<h4>标签引入</h4>

			<code lang="html" ref="domSCPUsage"></code>
			...
			<div class="grid">
				<a class="s12 m12 l4" href="/astatine-gear/font-source-code-pro/TTF-source-code-pro-2.042R-u_1.062R-i.zip"> <button class="responsive small elevate"> <i>folder_zip</i> Source Code Pro 2.042R u 1.062R i.zip</button> </a>
			</div>
		</details>
	</article>
	...
	<article class="blur">
		<details>
			...
			<a class="chip medium-elevate small primary" href="https://fonts.google.com/specimen/Cabin?query=cabin" target="_blank">
				<i class="small">home</i>
				<span>官网</span>
			</a>
			...
			<code lang="html" ref="domCabinUsage"></code>
			...
			<div class="grid">
				<a class="s12 m12 l4" href="/astatine-gear/font-cabin/cabin.zip"> <button class="responsive small elevate"> <i>folder_zip</i> cabin.zip</button> </a>
			</div>
		</details>
	</article>
...
<!-- 然后在 style 中声明字体 -->
<!-- 引入下述其一即可 -->
<!-- (不同版本区别在于字重, 数字越大, 字体越粗) -->
<style>
  body { font-family: HYWH35W, HYWH45W, HYWH55S, HYWH65W, HYWH75W, HYWH85W }
</style>`

	domSCPUsage.value.innerText = `<!-- 在 HTML 中引入 -->
<link rel="stylesheet" href="${window.location.origin}/astatine-gear/font-source-code-pro.css" />
...
<style>
  ...
  SourceCodePro-ExtraLight,
   ...
   SourceCodePro-SemiboldIt.ttf
	...
	domCabinUsage.value.innerText = `<!-- 在 HTML 中引入 -->
<link rel="stylesheet" href="${window.location.origin}/astatine-gear/font-cabin.css" />
...
<style>
  ...
  cabin-latin-500-italic,
  cabin-latin-500-normal,
  cabin-latin-600-italic,
  cabin-latin-600-normal,
